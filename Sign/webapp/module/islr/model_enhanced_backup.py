...
class IsolatedASLRecognition:
    ...
    def predict_custom_gesture(self, all_landmarks):
        ...
        try:
            ...
            confidence_threshold = 0.25  # Lowered to 25% for better detection
    ...
    def _is_no_action(self, sequence_array):
        ...
        try:
            ...
            # Thresholds for no action detection (more lenient)
            motion_threshold = 0.005  # Lowered minimum motion required
            variance_threshold = 0.003  # Lowered minimum variance required
